...
public final class NewAccountTransaction extends Transaction {
    public NewAccountTransaction(final CommandInput command) {
        super(command.getTimestamp(), "New account created", command.getAccount());
        setTransactionType("addAccount");
    }
