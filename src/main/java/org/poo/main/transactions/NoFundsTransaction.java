...
public final class NoFundsTransaction extends Transaction {
    public NoFundsTransaction(final CommandInput command) {
        super(command.getTimestamp(), "Insufficient funds", command.getAccount());
        setTransactionType("noFunds");
    }
