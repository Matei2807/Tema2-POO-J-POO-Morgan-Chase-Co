...
public final class CreateCardErrorTransaction extends Transaction {
    private String cardNumber;
    private String email;
    private String account;

    public CreateCardErrorTransaction(final CommandInput command) {
        super(command.getTimestamp(), "User is not the owner of the account", command.getAccount());
        setTransactionType("createCardError");
